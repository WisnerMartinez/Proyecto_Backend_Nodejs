...
// Ruta para obtener una imagen (Devuelve la imagen base64)
...
// Ruta para eliminar una imagen (pone le campo imagen a NULL)
...
// Ruta insertar una imagen (recibe la imagen en base64)
